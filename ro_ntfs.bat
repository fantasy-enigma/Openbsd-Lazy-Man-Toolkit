...
then
	ntfs-3g -o ro,uid=$uid,gid=$gid,fmask=137,dmask=027,locale=zh_CN.UTF-8,nodev,nosuid,noatime,max_read=131072,streams_interface=windows,windows_names,big_writes /dev/sd1l /mnt/ntfs
fi
